...
{
    public class RabbitMQService: IService, IDisposable
{
    const string BROKER_NAME = "eshop_event_bus";
        ...
        public EventBusRabbitMQ(IRabbitMQConnection persistentConnection, ILogger<RabbitMQService> logger,
            IServiceProvider serviceProvider, ISubscriptionsManager subsManager, string queueName = null, int retryCount = 5)
        {
